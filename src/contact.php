...
<body>
    ...
    <main class="container">
        <form id="contact-form" method="post" action="contact.php">
            ...
            <input maxlength="255" type="text" name="name" id="name" placeholder="Saller Yero">
            <label for="email">Youre Email Addess</label>
            ...
            <textarea rows="5" cols="50" name="message" id="message" placeholder="Message here..."></textarea>
            <div class="buttons">
